...
public class FacePamphletProfile implements FacePamphletConstants {
	...
	public Iterator<String> getFriends() {
		// You fill this in.  Currently always returns null.
		// return null;
        return friendArray.iterator();     // creates iterator and returns it
	}
	...
	public String toString() {
        ...
        Iterator<String> iter = friendArray.iterator();
        while (iter.hasNext()) {
            result += iter.next();
            if (iter.hasNext()) result += ", ";     // if iter has another result after, add a comma
        }
        return result;
	}

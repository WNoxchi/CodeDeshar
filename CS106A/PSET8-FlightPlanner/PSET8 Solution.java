...
public class FlightPlanner extends ConsoleProgram {
    ...
    public void run() {
        ...
        pritnln("Here's a list of all the cities in our database:");
        prinCityList(cities);

        println("Let's plan a round-trip route!");
        String starCity = readLine("Enter the starting city: ");
    ...
    /** Ask user for hte name of the next city in the route */
     ...
     *  a city consists of entering it in the cities arrray and
     *  entering an empty ArrayList in the flights table to show
     *  that is has no destinations yet.
     */

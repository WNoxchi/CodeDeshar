...
{
    // TODO: given a <place> (postal code & more) this FN will add a marker (icon)
    //       to the map.
    // FROM: https://github.com/davidventuri/harvard-cs50/blob/master/pset8/public/js/scripts.js
    // store place's latitude and longitude in a variable
...
function configure()
{
    ...
    },
    {
        ...
        templates: {
            ...
            // FROM: https://github.com/davidventuri/harvard-cs50/blob/master/pset8/public/js/scripts.js
            suggestion: _.template("<p><%- place_name %>, <%- admin_name1 %> <space style='color: #C0C0C0;'><%- postal_code %></span></p>")
        }
    });

...
def doit(initial_pos, move1, move2):
    ...
    ksi   = matrix([[initial_pos],[0.],[0.]])

    Omega += matrix([[1.,-1.,0.],[-1.,1.,0.],[0.,0.,0.]])
    ksi   += matrix([[-move1],[move1],[0.]])

    Omega += matrix([[0.,0.,0.],[0.,1.,-1.],[0.,-1.,1.]])
    ksi   += matrix([[0.],[-move2],[move2]])

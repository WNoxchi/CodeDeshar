# CS373 Artificial Intelligence for Robotics  -   PSet 3  -   Particle Filters
# Wayne H Nixalo  -   2017-Apr-20 14:39
...
class robot:
    ...
    #         if distance < 0.0:
    #             raise ValueError, 'Unable to move backwards'
    #
    #         # make a new copy
    #         result = robot()
    #         result.length = self.length
    ...
    #         else:
    #             # apprixmate bicycle model for motion

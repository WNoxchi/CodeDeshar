# Wayne H Nixalo - 2017-Jul-05 23:15
# Udacity CS373 - AI for Robotics - Final Project: Runaway Robot -- Python2
# ----------
# Background
#
...
# graphical visualization of grading
def demo_grading(estimate_next_pos_fcn, target_bot, OTHER = None):
    localized = False
    distance_tolerance = 0.01 * target_bot.distance
    ctr = 0
    ...
    CUTOFF = 40
    while not localized and ctr <= CUTOFF:
        ctr += 1
        measurement = target_bot.sense()
        position_guess, OTHER = estimate_next_pos_fcn(measurement, OTHER)
        target_bot.move_in_circle()
        true_position = (target_bot.x, target_bot.y)
        # # ##########
        # print true_position, position_guess, OTHER
        # # ##########
        error = distance_between(position_guess, true_position)
        # # ##########
        print error
